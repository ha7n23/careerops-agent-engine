...
- **Current quality baseline:** **450 passing tests**, **9 opt-in live integration tests skipped by default**, Ruff clean, and strict mypy checks across **152 source files**.
...
Current quality baseline: **450 passed, 9 skipped**, Ruff clean, strict mypy clean across **152 source files**.