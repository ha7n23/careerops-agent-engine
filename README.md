...
- **Current quality baseline:** **465 passing tests**, **9 opt-in live integration tests skipped by default**, Ruff clean, and strict mypy checks across **153 source files**.
...
Current quality baseline: **465 passed, 9 skipped**, Ruff clean, strict mypy clean across **153 source files**.